...
% Solución para evitar que los párrafos se separen excesivamente
\raggedbottom 
...
Science, acotadas al per\'{i}odo 2022--2026.
La selecci\'{o}n de estos
...
real.
Las m\'{e}tricas predominantes son la precisi\'{o}n media
...
para gestionar la oclusi\'{o}n y la baja iluminaci\'{o}n;
sin embargo,
...
The predominant evaluation metrics
...
handling occlusion and low illumination;
...
cr\'{i}ticas~\cite{E24, E32}.
La identificaci\'{o}n de personas en
...
\'{o}ptimo.
La oclusi\'{o}n ---entendida como la obstrucci\'{o}n
...
rendimiento de los detectores~\cite{Dollar2012, E27, E11}.
Aunque
...
la dependencia de la luz visible~\cite{E35, E31, E19, E26};
el
dise\~{n}o de m\'{o}dulos de atenci\'{o}n que prioricen las regiones
parcialmente visibles~\cite{E25, E32, E23};
y el desarrollo de
arquitecturas compactas orientadas a la inferencia en tiempo real sobre
hardware con recursos limitados~\cite{E21, E23}.
Sin embargo, no
...
oclusi\'{o}n y baja visibilidad;
(ii) sistematiza los conjuntos de
...
Secci\'{o}n~\ref{sec:metodo} describe el proceso metodol\'{o}gico;
la
...
monitoreada~\cite{E24, E32}.
Su evoluci\'{o}n hacia arquitecturas de
...
gesti\'{o}n del flujo peatonal en espacios p\'{u}blicos~\cite{E12, E09}.
Indicadores como la velocidad de inferencia, la precisi\'{o}n de
...
entorno que est\'{a} en el mismo \'{a}rea~\cite{E30}.
Se distinguen
...
concurridos o multitudes de gente~\cite{E28, E29}---;
y la oclusi\'{o}n
...
sensor.
Entre sus causas se encuentran la escasez de iluminaci\'{o}n
ambiental nocturna, la presencia de aerosoles como niebla o humo, y
las precipitaciones intensas~\cite{E21, E12, E13}.
Para afrontar estas
...
robustas ante cambios de iluminaci\'{o}n~\cite{E34, E35, E14};
y las
...
extraction'')) AND PUBYEAR $>$ 2021 AND 
DOCTYPE IN (``ar'',``cp'') AND
...
\midrule
CQ-1 & \textquestiondown El m\'{e}todo o modelo de detecci\'{o}n de personas ha sido documentado apropiadamente? & S\'{i} (1) / Parcial (0{,}5) / No (0) \\
CQ-2 & \textquestiondown El estudio eval\'{u}a el modelo en condiciones de oclusi\'{o}n y/o baja visibilidad de manera expl\'{i}cita? & S\'{i} (1) / Parcial (0{,}5) / No (0) \\
CQ-3 & \textquestiondown Se han documentado las limitaciones del estudio de manera clara? & S\'{i} (1) / Parcial (0{,}5) / No (0) \\
CQ-4 & \textquestiondown Los aportes del estudio para la comunidad cient\'{i}fica, acad\'{e}mica o para la industria han sido descritos? & S\'{i} (1) / Parcial (0{,}5) / No (0) \\
CQ-5 & \textquestiondown Los resultados han contribuido a responder las preguntas de investigaci\'{o}n planteadas? & S\'{i} (1) / Parcial (0{,}5) / No (0) \\
\midrule
\multicolumn{2}{l}{\textbf{Puntuaci\'{o}n m\'{i}nima de inclusi\'{o}n}} & $\geq 2{,}5$ / 5{,}0 \\
\bottomrule
\end{tabularx}
\end{table}
...
Tipo de publicaci\'{o}n  & Art\'{i}culo de revista / Art\'{i}culo de conferencia / Revisi\'{o}n \\
...
Condici\'{o}n de visibilidad & Baja iluminaci\'{o}n / Niebla / Lluvia / Nocturno / Varias / No especifica \\
...
{
\small
\begin{longtable}{c l >{\raggedright\arraybackslash}p{6cm} c c l}
...
\midrule
\multicolumn{6}{r}{\footnotesize\textit{Contin\'{u}a en la siguiente p\'{a}gina}} \\
\endfoot
...
separado;
existe una brecha en arquitecturas capaces de gestionar ambas
...
c\'{o}mputo embebido. La distribuci\'{o}n de estudios por base de datos muestra que ACM
...
Kitchenham y Charters. Respecto a los modelos existentes (RQ1), la fusi\'{o}n multiespectral
...
videovigilancia inteligente. Para la pr\'{a}ctica, los resultados sugieren que los equipos de
...
{
\small
\begin{longtable}{c l >{\raggedright\arraybackslash}p{6cm} c >{\raggedright\arraybackslash}p{3.8cm}}
...
\caption[]{Estudios primarios incluidos en la revisi\'{o}n (continuaci\'{o}n).} \\
\toprule
\textbf{ID} & \textbf{Autores} & \textbf{T\'{i}tulo} &
\textbf{A\~{n}o} & \textbf{Fuente} \\
\midrule
...
\midrule
\multicolumn{5}{r}{\footnotesize\textit{Contin\'{u}a en la siguiente p\'{a}gina}} \\
\endfoot
