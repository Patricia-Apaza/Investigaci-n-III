...
\textbf{Objetivo:} Sintetizar los models y t\'{e}cnicas documentados
...
\textbf{M\'{e}trico:} Se ejecut\'{o} una Revisi\'{o}n Sistem\'{a}tica de
...
second (\textit{FPS}).
\textbf{Conclusiones:} Multimodal fusion and attention mechanisms
...
\endhead
\midrule
\multicolumn{6}{r}{\textit{Contin\'{u}a en la pr\'{o}xima p\'{a}gina...}} \\
\endfoot
\bottomrule
\endlastfoot
...
\begin{itemize}
  ...
  \item \textbf{Validez de conclusi\'{o}n:} la heterogeneidad de
        ...
        comparaci\'{o}n quantitative directa entre modelos, por lo que
